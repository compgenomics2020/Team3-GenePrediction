...
def runBedtoolsIntersect(input_file, output_directory):
    ...
    prodigal_file = os.listdir("tool_output/prodigal_gff_result/")

    gms2_file = os.listdir("tool_output/gms2_gff_result/")
...
def runGetFASTA(input_file, output_directory):
    ...
    files4 = os.listdir("tool_output/MergedGFF/")
...
def runBLAST(output_directory):
    files6 = os.listdir(output_directory+"/MergedFASTA/")
